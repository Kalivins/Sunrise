...
#include "../../spawn/encounter_placement.h"
...
void render_frame_locked() noexcept {
    ...
    const bool markersDrawn = sunrise::client::hooks::spawn::encounter::draw_markers();
    ...
    if (!markersDrawn && !hudDrawn && !surfaceDrawn && !busyDrawn && !noticeDrawn) {
